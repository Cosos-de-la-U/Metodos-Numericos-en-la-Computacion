...
function getRegulafalsi() {
  ...
  //Calculado funcion en F(Xb)
  var scope = {
    x: Xb,
  };
  console.log("fXb : " + math.evaluate(expression, scope));
  var fXb = math.evaluate(expression, scope);

  //Calcular Xr
  var Xr = Xb-(fXb*(Xb-Xa))/(fXb-fXa);
  console.log("Xa : " + Xa);
  console.log("Xb : " + Xb);
  console.log("Xr : " + Xr);
  ...
  var row = `<tr class="bg-secondary">
    ...
    <td>${parseFloat(fXb).toFixed(6)}</td>
  ...
  do {
    ...
    console.log("fXb : " + math.evaluate(expression, scope));
    fXb = math.evaluate(expression, scope);

    //Calcular Xr
    var XrAnterior = Xr;
    Xr = Xb-(fXb*(Xb-Xa))/(fXb-fXa);
    console.log("Xa : " + Xa);
    console.log("Xb : " + Xb);
    console.log("Xr : " + Xr);
